...
この文章はCode for AmericaのCode of Conductを元に、オンライン対応が増えてきた２０２０年に改変したものです。
https://hackmd.io/@codeforjapan/CoCguide

[Code for America の Code of Conduct](https://github.com/codeforamerica/codeofconduct)を日本語訳し、若干の改変を加えたものを以前は利用していました。
https://hackmd.io/@codeforjapan/CodeOfConduct

## はじめに
Code for Japan が開催するイベントを、参加している全員にとって居心地のいい場所にするためのガイドラインです。参加者の安全性を担保するために、参加者全員が数々のハラスメントについて理解する必要があります。ときに人は無自覚なものです。だからこそ、参加歴の長さにかかわらず、お互いに気をつけなければいけないことがあります。このガイドラインを心に留め、誰もが楽しく参加できる場にしていきましょう。
...
- メール: CoC@code4japan.org(CoC窓口に届きます。)
- Slack:二人宛へDMでいただいた方が早めにお返事することができますが、ケースや内容によっては、どちらか一人宛へのDMも可能です。
    - [@jinnouchi](https://cfj.slack.com/team/U08TUNXH8) （Code for Japan 事務局長）
    - [@takesada_C4J](https://cfj.slack.com/team/UA3UCG9MM) （Code for Japan コミュニティマネージャー）
